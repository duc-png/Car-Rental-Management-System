...
function AppLayout() {
  ...
  return (
    <>
      ...
      {!isOwnerDashboard &&
        <Navbar sticky={!isCarDetailsPage} />
      }
      ...
      <main className={isOwnerDashboard ? 'owner-main' : ''}>
        ...
        <Routes>
          ...
          <Route
            path="/booking/:id/payment-success"
            element={<PaymentSuccess />}
          />

          <Route
            path="/booking/:id/payment-cancel"
          ...
          <Route
            ...
            element={<OwnerVehicleDetails />}
          />

          <Route
            path="/owner/vehicles/:id/edit"
            element={<OwnerVehicleEdit />}
          />
          ...
          <Route path="/admin" element={<AdminLayout />}>
            ...
            <Route
              path="vehicles/:id"
              element={<AdminVehicleRequestDetails />}
            />

            <Route
              path="owner-registrations"
              element={<AdminOwnerRegistrations />}
            />

            <Route
              path="owner-registrations/:id"
              element={<AdminOwnerRegistrationDetails />}
            />
