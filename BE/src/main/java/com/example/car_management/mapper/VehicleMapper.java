...
public class VehicleMapper {
    ...
    public static VehicleResponse toResponse(VehicleEntity e) {
        ...
        return VehicleResponse.builder()
                ...
                .deliveryEnabled(e.getDeliveryEnabled())
                .freeDeliveryWithinKm(e.getFreeDeliveryWithinKm())
                .maxDeliveryDistanceKm(e.getMaxDeliveryDistanceKm())
                .extraFeePerKm(e.getExtraFeePerKm())
                .locationId(locationId)
                .province(e.getLocation() != null ? e.getLocation().getProvince() : null)
                .district(e.getLocation() != null ? e.getLocation().getDistrict() : null)
                .ward(e.getLocation() != null ? e.getLocation().getWard() : null)
                .city(e.getLocation() != null ? e.getLocation().getProvince() : null)
