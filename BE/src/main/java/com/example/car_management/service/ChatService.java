...
public class ChatService {
        ...
        public ChatConversationResponse startConversationByVehicle(StartConversationRequest request) {
                ...
                ChatConversationEntity conversation = chatConversationRepository
                                .findFirstByCustomerIdAndOwnerIdAndVehicleIdOrderByLastMessageAtDesc(customerId,
        ...
        public List<ChatConversationResponse> getMyConversations() {
                ...
                List<ChatConversationEntity> conversations = chatConversationRepository
                                .findByCustomerIdOrOwnerIdOrderByLastMessageAtDesc(currentUser.getId(),
                                                currentUser.getId());
        ...
        private ChatConversationResponse toConversationResponse(ChatConversationEntity conversation, Integer viewerId) {
                ...
                return ChatConversationResponse.builder()
                                ...
                                .customerId(conversation.getCustomer() != null ? conversation.getCustomer().getId()
                                                : null)
                                ...
                                .otherUserRole(otherUser != null && otherUser.getRoleId() != null
                                                ? otherUser.getRoleId().name()
                                                : null)
                                ...
                                .unreadCount(chatMessageRepository.countByConversationIdAndSenderIdNotAndIsReadFalse(
        ...
        private ChatMessageResponse toMessageResponse(ChatMessageEntity message) {
                return ChatMessageResponse.builder()
                                .id(message.getId())
                                .conversationId(message.getConversation() != null ? message.getConversation().getId()
                                                : null)
